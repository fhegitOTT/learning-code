...
<body id="body-layout" class="easyui-layout"  style="margin-right:1px;margin-left:1px;">
	<form name="frmInfo1" id="form1" action="" method="post">
			...
			<div id="houseGrid" class="easyui-panel" title="已关联的房屋列表" style="width:100%;height:350px;background:#fafafa;" data-options="iconCls:'icon-collapse',noheader:false">
			</div>
			<%-- <div id="houseGrid" class="easyui-panel" title="已关联的房屋列表" style="width:100%;height:350px;background:#fafafa;" data-options="iconCls:'icon-collapse',noheader:false">
				<table id="houseDataGrid" class="easyui-datagrid" style="width:100%;height:500px"
				data-options="idField:'houseID',rownumbers:true,singleSelect:false,checkOnSelect:true,url:'<%=path%>/inner/permitmanage/doSearchHousesByBuildingID.action',method:'post'">
					<thead>
						<tr style="width: 100%">
							<th data-options="field:'room_Number',width:100, editor:false,align:'center'">室号</th>
							<th data-options="field:'houseID',width:100, editor:false,align:'center'">房屋编号</th>
							<th data-options="field:'location_Name',width:100,align:'center',editor:false">房屋坐落</th>
							<th data-options="field:'areaCert',width:100,align:'center',editor:false">预测/实测面积</th>
							<th data-options="field:'permit',width:100,align:'center',editor:false">预售许可</th>
							<th data-options="field:'reals',width:100,align:'center',editor:false">产权</th>
							<th data-options="field:'others',width:100,align:'center',editor:false">抵押</th>
							<th data-options="field:'limits',width:100,align:'center',editor:false">限制</th>
							<th data-options="field:'hires',width:100,align:'center',editor:false">租赁</th>
							<th data-options="field:'files',width:100,align:'center',editor:false">文件</th>
						</tr>
					</thead>
				</table>
			</div> --%>
