...
<body id="body-layout" class="easyui-layout"  style="margin-right:1px;margin-left:1px;overflow: auto; ">
	...
	<table class="input_table" cellpadding="5" cellspacing="1px" style="width:100%;background-color: #7DD5FF">
		...
		<tr>
			<td colspan="2" align="center" bgcolor="white">企业名称：${name}</td>
		</tr>
		<tr>
			<td colspan="2" align="center" bgcolor="white">请选项目：<input class="easyui-combobox" name="projectID" id="projectID"
					data-options="url:'<%=path%>/inner/pwdmodify/queryProject.action?compCode=${compCode}',valueField:'project_id',textField:'projectname',
