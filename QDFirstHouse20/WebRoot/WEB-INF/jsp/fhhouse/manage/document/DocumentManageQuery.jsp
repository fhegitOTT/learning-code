...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		function docManageList(){
			document.frmInfo1.action="<%=basePath%>/inner/document/docResultList.action";
			document.frmInfo1.target="_blank";
			document.frmInfo1.submit();
		}
		
		function doQuery(){
			document.frmInfo1.action="<%=basePath%>/inner/document/gotoDocumentManageList.action";
			document.frmInfo1.target="listfrm";
			document.frmInfo1.submit();
		}
...
<body id="body-layout" class="easyui-layout"  style="margin-right:1px;margin-left:1px">
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'center',title:'收件一览',iconCls:'icon-ok'" style="background-color:#d9e4f2;">
				...
				&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="#" class="easyui-linkbutton" data-options="iconCls:'icon-save'" style="width:150px;text" onclick="docManageList()">流转结果清单</a>&nbsp;&nbsp;
								</td>
					    	</tr> 
						    </table>
						</form>
