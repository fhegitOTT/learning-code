...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
	 	...
	 	function doSearch(id,Flag){
	 		parent.window.location="<%=path%>/inner/Pricemanage/gotoGuideCkHouseByIdList.action?project_id="+id;
	 	}
...
<body id="body-layout" class="easyui-layout"  style="margin-right:1px;margin-left:1px;">
		...
		<div id="p" class="easyui-panel" title="项目列表查询"
