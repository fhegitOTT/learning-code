...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
 	...
 	function doPriceUpdate(building_ID,start_ID){
 		var url ="<%=path%>/inner/Pricemanage/priceUpdateInfo.action?building_ID="+building_ID+"&start_ID="+start_ID;
 		//window.open(url,"均价幅度修改",'width=650,height=250');
 		parent.openDialog("均价幅度修改",url,650,200);
 	}
	</script>
	</head>
	<body id="body-layout" class="easyui-layout" style="margin-right: 1px; margin-left: 1px">
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'center',title:'房屋列表',iconCls:'icon-ok'">
