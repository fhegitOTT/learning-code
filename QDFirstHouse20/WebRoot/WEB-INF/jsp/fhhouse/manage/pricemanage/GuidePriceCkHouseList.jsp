...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
 	...
 	function doPriceUpdate(building_ID,project_id){
 		window.location="<%=path%>/inner/Pricemanage/GuideHouseCkByIdList.action?building_ID="+building_ID+"&project_id="+project_id;
 	}
 	function gotoBack(){
 		window.location="<%=path%>/inner/Pricemanage/gotoGuidePriceCk.action?";
 	}
	</script>
	</head>
