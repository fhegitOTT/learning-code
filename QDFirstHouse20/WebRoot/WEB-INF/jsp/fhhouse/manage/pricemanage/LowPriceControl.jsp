...
<body id="body-layout" class="easyui-layout"  style="margin-right:1px;margin-left:1px">
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'center',title:'价格监控',iconCls:'icon-ok'" style="background-color:#d9e4f2;">
				<div class="easyui-layout" data-options="fit:true">
					<div data-options="region:'north',split:true,border:false" style="height:65px;padding-top:5px;" id="div1"> 
						<form name="frmInfo1" id="form1" target="listfrm" method="post" action="<%=basePath%>/inner/Pricemanage/gotoLowPriceControlList">
							<table width="100%">
							<tr>
								<td align="center">
									&nbsp;&nbsp;项目名称：<input class="easyui-textbox" type="text" name="projectName" id="projectName"></input>
									&nbsp;&nbsp;楼栋名称：<input class="easyui-textbox" type="text" name="buildingName" id="buildingName"></input>
