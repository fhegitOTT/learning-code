...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			function doPrint(){
				...
				//finalMark = encodeURI(encodeURI(finalMark));
				window.open("<%=path%>/inner/companymanage/gotoCompanyAudit.action?print=print&id="+ id+"&finalMark="+finalMark+"&status="+status,"");
			}
			function doBack(){
	...
	<body id="body-layout">
		<form id="frmInfo" name="frmInfo" method="post" action="<%=path%>/inner/companymanage/gotoCompanyAuditPass.action">
					...
					<td>
						...
						<table class="input_table" cellpadding="5" cellspacing="1px" style="width: 95%; background-color: #7DD5FF" align="center">
                						...
                						<tr> 
                  							...
                  							<td class="input_left"  width="65%"  bgcolor="#5BADFF"> 
               		 						...
               		 						<tr>
                  								...
                  								<td class="input_right"  width="65%" align="center">
                  								<%
							...
							<tr>
								...
								<td class="input_right" colspan="3">
									<textarea rows="6" name="finalMark" id="finalMark" cols="70" class="easyui-validatebox" data-options="validType:'length[0,100]'"></textarea>
									<div align="left">
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<label>
											<input type="radio" name="type1" value="1" />同意
										</label>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<label>
											<input type="radio" name="type1" value="2" checked/>不同意
										</label>
									</div>
								</td>
							</tr>
			...
			<p align="center">
				<a href="javascript:document.frmInfo.submit();$('#submit').linkbutton('disable');" id="submit" class="easyui-linkbutton" data-options="iconCls:'icon-ok'" style="width: 80px">确定</a>
