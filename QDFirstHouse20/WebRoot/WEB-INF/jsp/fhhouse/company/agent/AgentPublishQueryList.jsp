...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">	
		...
		function doAgentEdit(agentID){
			parent.window.location="<%=path%>/inner/agentmanage/gotoAgentPublishEdit.action?cmd=edit&agentID="+agentID;
		}
...
<body id="body-layout" class="easyui-layout"  style="margin-right:1px;margin-left:1px;">
		...
		<div id="p" class="easyui-panel" title="待发布的销售代理商列表"
