...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">	
		...
		function doCompanyEdit2(agentID){
			parent.window.location="<%=path%>/inner/agentmanage/gotoAgentEdit.action?cmd=edit&logo=${logo}&agentID="+agentID;
		}
...
<body id="body-layout" class="easyui-layout"  style="margin-right:1px;margin-left:1px;">
		...
		<div id="p" class="easyui-panel" title="<c:if test="${logo=='part'}">未提交审核的销售代理商列表</c:if>"
