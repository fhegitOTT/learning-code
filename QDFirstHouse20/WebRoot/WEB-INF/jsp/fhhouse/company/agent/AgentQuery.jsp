...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<script type="text/javascript">
		...
		function addAgent(){
			window.location.href="<%=basePath%>/inner/agentmanage/gotoAgentEdit.action?cmd=add&logo=part";
		}
			...
			<div data-options="region:'center',title:'青岛市网上房地产申报资格认证',iconCls:'icon-ok'" style="background-color:#d9e4f2;">
				<div class="easyui-layout" data-options="fit:true">
					<div data-options="region:'north',split:true,border:false" style="height:65px;padding-top:5px;" id="div1"> 
						<form name="frmInfo1" id="form1" target="listfrm" method="post" action="<%=basePath%>/inner/agentmanage/gotoAgentAddQueryList.action">
							<table width="100%">
							<tr>
								<td>
									...
									&nbsp;&nbsp;<a href="javascript:addAgent()" class="easyui-linkbutton" data-options="iconCls:'icon-add'" style="width:80px">添    加</a>
								</td>
					    	</tr> 
						    </table>
						</form>
