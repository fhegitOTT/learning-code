...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript">
			function doPrint(){
				...
				window.open("<%=path%>/inner/companymanage/gotoProjectAudit.action?print=print&id="+ id+"&finalMark="+finalMark+"&status="+status,"");
			}
			function doBack(){
	...
	<body id="body-layout" >
		<div align="center">
			<form id="frmInfo" name="frmInfo" method="post" action="<%=path%>/inner/companymanage/gotoProjectAuditPass.action">
