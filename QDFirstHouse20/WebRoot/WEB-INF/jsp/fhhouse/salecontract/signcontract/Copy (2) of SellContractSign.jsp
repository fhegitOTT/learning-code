		...
		%>
			...
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;该商品房交付时应当符合下列第1、2、<input type="text" name="f1001" size="15" value="${csdVo.f1001 }" maxlength="10" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十条 ">项所列条件： 
					</td></tr>
					<tr><td>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;3.<input type="text" name="f1002" size="50" value="${csdVo.f1002 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十条 3">；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;4.<input type="text" name="f1003" size="50" value="${csdVo.f1003 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十条 4">。
					</td></tr>
					<tr><td>
			...
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f1101" size="100" value="${csdVo.f1101 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 1">;
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;2.供电：交付时纳入城市供电网络并正式供电，
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f1102" size="100" value="${csdVo.f1102 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 2">;
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;3.供暖：交付时供热系统符合供热配建标准，使用城市集中供热的，纳入城市集中供热管网，
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f1103" size="100" value="${csdVo.f1103 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 3">；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;4.燃气：交付时完成室内燃气管道的敷设，并与城市燃气管网连接，保证燃气供应，
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f1104" size="100" value="${csdVo.f1104 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 4">；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;5.电话通信：交付时线路敷设到户； 
					</td></tr>
					...
					<tr><td>
						...
						<select name="f1105">
							<option value="（1）" <c:if test="${csdVo.f1105 eq '（1）'  }">selected</c:if> >（1）</option>
							<option value="（2）" <c:if test="${csdVo.f1105 eq '（2）'  }">selected</c:if> >（2）</option>
						</select>
						种方式处理：
					</td></tr>
						<tr><td>
						...
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;第5项未按时达到交付使用条件的，出卖人按日向买受人支付<input type="text" name="f1106" size="15" value="${csdVo.f1106 }" maxlength="15" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">元的违约金；第6项未按时达到交付使用条件的，
						出卖人按日向买受人支付<input type="text" name="f1107" size="15" value="${csdVo.f1107 }" maxlength="15" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">元的违约金；
						第7项未按时达到交付使用条件的，出卖人按日向买受人支付<input type="text" name="f1108" size="15" value="${csdVo.f1108 }" maxlength="15" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">元的违约金。
						出卖人采取措施保证相关设施于约定交付日后<input type="text" name="f1109" size="15" value="${csdVo.f1109 }" maxlength="15" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">日之内达到交付使用条件。
					</td></tr>
					<tr><td >&nbsp;&nbsp;&nbsp;&nbsp;（2）
						<textarea class="input_text" name="f1110"  rows="6" style="width:85%" features="bmust=0,datatype=0,maxlength=2000,showtitle=第十一条  （一）（2）">${csdVo.f1110 }</textarea>
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（二）公共服务及其他配套设施（以建设工程规划许可为准）
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;1.小区内绿地率：<input type="text" name="f1111" size="15" value="${csdVo.f1111 }" maxlength="13" class="input_text" features="bmust=0,datatype=2,minlength=0,maxlength=13,showtitle=第十一条 ">&nbsp;
						达到：<input type="text" name="f1112" size="30" value="${csdVo.f1112 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">；
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;2.小区内非市政道路：<input type="text" name="f1113" size="15" value="${csdVo.f1113 }" maxlength="13" class="input_text" features="bmust=0,datatype=2,minlength=0,maxlength=13,showtitle=第十一条 ">&nbsp;
						达到：<input type="text" name="f1114" size="30" value="${csdVo.f1114 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">；
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;3.规划的车位、车库：<input type="text" name="f1115" size="15" value="${csdVo.f1115 }" maxlength="13" class="input_text" features="bmust=0,datatype=2,minlength=0,maxlength=13,showtitle=第十一条 ">&nbsp;
						达到：<input type="text" name="f1116" size="30" value="${csdVo.f1116 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">；
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;4.物业服务用房：<input type="text" name="f1117" size="15" value="${csdVo.f1117 }" maxlength="13" class="input_text" features="bmust=0,datatype=2,minlength=0,maxlength=13,showtitle=第十一条 ">&nbsp;
						达到：<input type="text" name="f1118" size="30" value="${csdVo.f1118 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">；
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;5、医疗卫生机构： <input type="text" name="f1119" size="15" value="${csdVo.f1119 }" maxlength="13" class="input_text" features="bmust=0,datatype=2,minlength=0,maxlength=13,showtitle=第十一条 ">&nbsp;
						达到：<input type="text" name="f1120" size="30" value="${csdVo.f1120 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">；
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;6.幼儿园：<input type="text" name="f1121" size="15" value="${csdVo.f1121 }" maxlength="13" class="input_text" features="bmust=0,datatype=2,minlength=0,maxlength=13,showtitle=第十一条 ">&nbsp;
						达到：<input type="text" name="f1122" size="30" value="${csdVo.f1122 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">；
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;7.学校：<input type="text" name="f1123" size="15" value="${csdVo.f1123 }" maxlength="13" class="input_text" features="bmust=0,datatype=2,minlength=0,maxlength=13,showtitle=第十一条 ">&nbsp;
						达到：<input type="text" name="f1124" size="30" value="${csdVo.f1124 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">；
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;8.<input type="text" name="f1125" size="100" value="${csdVo.f1125 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">；
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;9.<input type="text" name="f1126" size="100" value="${csdVo.f1126 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">。
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;以上设施未达到上述条件的，双方同意按照以下方式处理：
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;1.小区内绿地率未达到上述约定条件的，<input type="text" name="f1127" size="30" value="${csdVo.f1127 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">。
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;2.小区内非市政道路未达到上述约定条件的，<input type="text" name="f1128" size="30" value="${csdVo.f1128 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">。
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;3.规划的车位、车库未达到上述约定条件的，<input type="text" name="f1129" size="30" value="${csdVo.f1129}" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">。
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;4.物业服务用房未达到上述约定条件的，<input type="text" name="f1130" size="30" value="${csdVo.f1130 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">。
					</td></tr>
						<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;5.其他设施未达到上述约定条件的，<input type="text" name="f1131" size="30" value="${csdVo.f1131 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十一条 ">。
					</td></tr>
						<tr><td>
			...
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;(一)出卖人应当在
						<input type="text" class="demo-input" name="f1201" id="f1201" placeholder="" value="${csdVo.f1201}" readonly="readonly" features="bmust=1,datatype=2,minlength=0,maxlength=50,showtitle=第十二条 交付时间"/><font color="red">*</font>
						<script>
							//执行一个laydate实例
							laydate.render({
							  elem: '#f1201' //指定元素
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;(二)该商品房达到第十条、第十一条约定的交付条件后，出卖人应当在交付日期届满前<input type="text" name="f1202" size="15" value="${csdVo.f1202 }" maxlength="15" class="input2" features="bmust=1,datatype=3,minvalue=10,minlength=0,maxlength=50,showtitle=第十二条 "><font color="red">*</font>日〔不少于10日）将查验房屋的时间、办理交付手续的时间地点以及应当携带的证件材料的通知书面送达买受人。买受人未收到交付通知书的，以本合同约定 的交付日期届满之日为办理交付手续的时间，以该商品房所在地为办理交付手续的地点。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f1203" size="100" value="${csdVo.f1203 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十二条 ">。
					</td></tr>
					<tr><td>
					...
					<tr><td>
						...
						由出卖人按照有关工程和产品质量规范、标准自查验次日起<input type="text" name="f1204" size="15" value="${csdVo.f1204 }" maxlength="13" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十二条 ">日内负责修复，并承担修复费用，修复后再行交付。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（1）屋面、墙面、地面渗漏或开裂等；
					</td></tr>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（5）<input type="text" name="f1205" size="100" value="${csdVo.f1205 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十二条 ">；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（6）<input type="text" name="f1206" size="100" value="${csdVo.f1206 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十二条 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;3.查验该商品房后，双方应当签署商品房交接单。由于买受人原因导致该商品房 未能按期交付的，双方同意按照以下方式处理：
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（1）<input type="text" name="f1207" size="100" value="${csdVo.f1207 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十二条 ">；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（2）<input type="text" name="f1208" size="100" value="${csdVo.f1208 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十二条 ">。
					</td></tr>
				</table>
			</td></tr>
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						...
						<select name="f1301" onchange="tk13_change(this.value);">
							<option value="1" <c:if test="${csdVo.f1301 eq 1  }">selected</c:if> >1</option>
							<option value="2" <c:if test="${csdVo.f1301 eq 2  }">selected</c:if> >2</option>
						</select>
						种方式处理：
					</td></tr>
					<tr><td>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;(1）逾期在<input type="text" name="f1302" size="15" value="${csdVo.f1302 }" maxlength="15" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十三条 ">日之内〔该期限应当不多于第九条第1 (1）项中的期限），自第 十二条约定的交付期限届满之次日起至实际交付之日止，出卖人按日计算向买受人支付全部房价款万分之
						<input type="text" name="f1303" size="15" value="${csdVo.f1303 }" maxlength="15" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十三条 ">的违约金〔该违约金比率应当不低于第九条第1 (1）项中的比率)。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（2）逾期超过<input type="text" name="f1304" size="15" value="${csdVo.f1304 }" maxlength="15" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十三条 ">日〔该期限应当与本条第（1）项中的期限相同）后，买受人有权解除合同。买受人解除合同的，应当书面通知出卖人。出卖人应当自解除合同通知送达之日起15日内退还买受人已付全部房款（含已付贷款部分），
						并自买受人付款之日起，按照<input type="text" name="f1305" size="15" value="${csdVo.f1305 }" maxlength="15" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十三条 ">%(不低于中国人民银行公布的同期贷款基准利率）计算给付利息；
						同时，出卖人按照全部房价款的<input type="text" name="f1306" size="15" value="${csdVo.f1306 }" maxlength="50" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十三条 ">%向买受人支付违约金。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;买受人要求继续履行合同的，合同继续履行，出卖人按日计算向买受人支付全部 房价款万分之<input type="text" name="f1307" size="15" value="${csdVo.f1307 }" maxlength="15" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十三条 ">(该比率应当不低于本条第1 (1）项中的比率）的违约金。
					</td></tr>
					<tr><td >&nbsp;&nbsp;&nbsp;&nbsp;2、
						<textarea class="input_text" name="f1308"  rows="8" style="width:85%" features="bmust=0,datatype=0,maxlength=2000,showtitle=第十三条 处理方式2">${csdVo.f1308 }</textarea>。
					</td></tr>
				</table>
			</td></tr>
			...
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						...
						按照<input type="text" name="f1401" size="15" value="${csdVo.f1401 }" maxlength="15" class="input2" features="bmust=1,datatype=1,minlength=0,maxlength=50,showtitle=第十四条 "><font color="red">*</font>%(不低于中国人民银行公布的同 期贷款基准利率）计算给付利息。给买受人造成损失的，由出卖人支付
						<select id="N14_2" name="f1402" style="width:150px;"></select>
						<input type="hidden" id="N14_2id" value="${csdVo.f1402}"/>
						的赔偿金。因此而发生的检测费用由出卖人承担。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;买受人不解除合同的，<input type="text" name="f1403" size="50" value="${csdVo.f1403 }" maxlength="100" class="input2" features="bmust=1,datatype=0,minlength=0,maxlength=50,showtitle=第十四条 "><font color="red">*</font>。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;(二）其他质量问题
					</td></tr>
					...
					<tr><td >&nbsp;&nbsp;&nbsp;&nbsp;
						<textarea class="input_text" name="f1404"  rows="8" style="width:85%" features="bmust=0,datatype=0,maxlength=2000,showtitle=第十四条  (二）其他质量问题">${csdVo.f1404 }</textarea>。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（2）经过更换、修理，仍然严重影响正常使用的，买受人有权解除合同。买受人解除合同的，应当书面通知出卖人。出卖人应当自解除合同通知送达之日起15日内退 还买受人已付全部房款（含已付贷款部分），并自买受人付款之日起，
						按照<input type="text" name="f1405" size="15" value="${csdVo.f1405 }" maxlength="15" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十四条 ">%(不低于中国人民银行公布的同期贷款基准利率）计算给付利息。给买受人造成损失 的，由出卖人承担相应赔偿责任。因此而发生的检测费用由出卖人承担。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;买受人不解除合同的，<input type="text" name="f1406" size="50" value="${csdVo.f1406 }" maxlength="100" class="input2" features="bmust=1,datatype=0,minlength=0,maxlength=50,showtitle=第十四条 "><font color="red">*</font>。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;(三）装饰装修及设备标准
					</td></tr>
					...
					<tr><td>
						...
						、<input type="text" name="f1407" size="15" value="${csdVo.f1407 }" maxlength="50" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十四条 ">方 式处理（可多选）：
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（1）及时更换、修理；
					</td></tr>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（3）<input type="text" name="f1408" size="100" value="${csdVo.f1408 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十四条 ">；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（4）<input type="text" name="f1409" size="100" value="${csdVo.f1409 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十四条 ">。
					</td></tr>
					<tr><td>
					...
					<tr><td>
						...
						<input type="hidden" id="N14_11id" value="${csdVo.f1410 }"/>
						标准，
						标准名称：<input type="text" name="f1411" size="30" value="${csdVo.f1411 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十四条 空气质量 标准名称">，
						标准文号：<input type="text" name="f1412" size="30" value="${csdVo.f1412 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十四条 空气质量 标准文号">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;该商品房为住宅的，建筑隔声情况符合
						<select id="N14_14" name="f1413" style="width:100px;"></select>
						<input type="hidden" id="N14_14id" value="${csdVo.f1413 }"/>
						标准，
						标准名称：<input type="text" name="f1414" size="30" value="${csdVo.f1414 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十四条 隔声情况 标准名称">，
						标准文号：<input type="text" name="f1415" size="30" value="${csdVo.f1415 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十四条 隔声情况 标准文号">。
					</td></tr>
					<tr><td>
						...
						按照<input type="text" name="f1416" size="15" value="${csdVo.f1416 }" maxlength="50" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十四条 ">%〔不低于中国人民银行公布的同期贷款基准利率）计算给付利息。给买受人造成损失的，由出卖人承担相应赔偿责任。经检测不符合标准的，检测费用由出卖人承担，整改后再次检测发生的费用仍由 出卖人承担。因整改导致该商品房逾期交付的，出卖人应当承担逾期交付责任。
					</td></tr>
					<tr><td>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f1417" size="50" value="${csdVo.f1417 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十四条 ">。
					</td></tr>
				</table>
			</td></tr>
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;3.<input type="text" name="f1501" size="100" value="${csdVo.f1501 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十五条 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;(三）在保修期内，买受人要求维修的书面通知送达出卖人<input type="text" name="f1502" size="15" value="${csdVo.f1502 }" maxlength="15" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十五条 ">日内，出卖人既不履行保修义务也不提出书面异议的，买受人可以自行或委托他人进行维修，维修费用及维修期间造成的其他损失由出卖人承担。
					</td></tr>
				</table>
			</td></tr>
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						...
						由<input type="text" name="f1601" size="25" value="${csdVo.f1601 }" maxlength="50" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十六条 ">承担连带责任。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;关于质量担保的证明见附件九。
					</td></tr>
			...
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;(二）因出卖人的原因，买受人未能在该商品房交付之日起<input type="text" name="f1701" size="15" value="${csdVo.f1701 }" maxlength="15" class="input2" features="bmust=1,datatype=1,minlength=0,maxlength=50,showtitle=第十七条 "><font color="red">*</font>日内取得该商品房的房屋所有权证书的，
						双方同意按照下列第
						<select name="f1702">
							<option value="1" <c:if test="${csdVo.f1702 eq 1  }">selected</c:if> >1</option>
							<option value="2" <c:if test="${csdVo.f1702 eq 2  }">selected</c:if> >2</option>
						</select>
						种方式处理：
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;1.买受人有权解除合同。买受人解除合同的，应当书面通知出卖人。出卖人应当自解除合同通知送达之日起15日内退还买受人已付全部房款（含已付贷款部分），并自 买受人付款之日起，
						按照<input type="text" name="f1703" size="15" value="${csdVo.f1703 }" maxlength="15" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十七条 ">% （不低于中国人民银行公布的同期贷款基准利率） 计算给付利息。买受人不解除合同的，自买受人应当完成房屋所有权登记的期限届满之次日起至实际完成房屋所有权登记之日止，
						出卖人按日计算向买受人支付全部房价款万分之<input type="text" name="f1704" size="15" value="${csdVo.f1704 }" maxlength="50" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十七条 ">的违约金。
					</td></tr>
					<tr><td >&nbsp;&nbsp;&nbsp;&nbsp;2、
						<textarea class="input_text" name="f1705"  rows="8" style="width:85%" features="bmust=0,datatype=0,maxlength=2000,showtitle=第十七条">${csdVo.f1705 }</textarea>。
					</td></tr>
					<tr><td>
			...
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;(一)出卖人依法选聘的前期物业服务企业为<input type="text" name="f1801" size="50" value="${csdVo.f1801 }" maxlength="100" class="input2" features="bmust=1,datatype=0,minlength=0,maxlength=50,showtitle=第十八条 "><font color="red">*</font>。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;(二）物业服务时间从
						<input type="text" class="demo-input" name="f1802" id="f1802" placeholder="" value="${csdVo.f1802}" readonly="readonly" features="bmust=1,datatype=2,minlength=0,maxlength=50,showtitle=第十八条 "/><font color="red">*</font>
						<script>
							//执行一个laydate实例
							laydate.render({
							  elem: '#f1802' //指定元素
						...
						到
						<input type="text" class="demo-input" name="f1803" id="f1803" placeholder="" value="${csdVo.f1803}" readonly="readonly" features="bmust=1,datatype=2,minlength=0,maxlength=50,showtitle=第十八条 "/><font color="red">*</font>
						<script>
							//执行一个laydate实例
							laydate.render({
							  elem: '#f1803' //指定元素
					...
					<tr><td>
						...
						<input type="hidden" id="N18_4id" value="${csdVo.f1804 }"/>
						。物业 服务费为<input type="text" name="f1805" size="15" value="${csdVo.f1805 }" maxlength="15" class="input2" features="bmust=1,datatype=1,minlength=0,maxlength=50,showtitle=第十八条 "><font color="red">*</font>元/月·平方米（建筑面积）。
					</td></tr>
					<tr><td>
			...
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;3.<input type="text" name="f1901" size="100" value="${csdVo.f1901 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十九条 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;(三）双方对其他配套设施约定如下:
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;1.规划的车位、车库：<input type="text" name="f1902" size="50" value="${csdVo.f1902 }" maxlength="100" class="input2" features="bmust=1,datatype=0,minlength=0,maxlength=50,showtitle=第十九条 "><font color="red">*</font>；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;2. 会所：<input type="text" name="f1903" size="50" value="${csdVo.f1903 }" maxlength="100" class="input2" features="bmust=1,datatype=0,minlength=0,maxlength=50,showtitle=第十九条 "><font color="red">*</font>；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;3.<input type="text" name="f1904" size="50" value="${csdVo.f1904 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第十九条 ">。
					</td></tr>
				</table>
			</td></tr>
			<tr><td>
			...
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;6.<input type="text" name="f2101" size="100" value="${csdVo.f2101 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第二十一条 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;7.<input type="text" name="f2102" size="100" value="${csdVo.f2102 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=第二十一条 ">。
					</td></tr>
				</table>
			</td></tr>
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						...
						<input type="hidden" id="N22_2id" value="${csdVo.f2201 }"/>
						方式送达对方。任何一方变更通讯地址、联系电话的，
						应在变更之日起<input type="text" name="f2202" size="15" value="${csdVo.f2202 }" maxlength="15" class="input2" features="bmust=1,datatype=1,minlength=0,maxlength=50,showtitle=第二十二条 "><font color="red">*</font>日内书面通知对方。变更的一方未履行通知义务导致送达不能的，应承担相应的法律责任。
					</td></tr>
				</table>
			</td></tr>
			<tr><td>
			...
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						...
						<input type="hidden" id="FJ7_1id" value="${csdVo.f9001 }"/>
						；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9002" size="50" value="${csdVo.f9002 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;2.起居室：
					</td></tr>
					<tr><td>
						...
						<input type="hidden" id="FJ7_3id" value="${csdVo.f9003 }"/>
						；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9004" size="50" value="${csdVo.f9004 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（2）顶棚：
						<select id="FJ7_5" name="f9005" style="width:100px;" ></select>
						<input type="hidden" id="FJ7_5id" value="${csdVo.f9005 }"/>
						；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9006" size="50" value="${csdVo.f9006 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（3）室内地面：
						<select id="FJ7_7" name="f9007" style="width:100px;" ></select>
						<input type="hidden" id="FJ7_7id" value="${csdVo.f9007 }"/>
						；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp<input type="text" name="f9008" size="50" value="${csdVo.f9008 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;3.厨房：
					</td></tr>
					<tr><td>
						...
						<input type="hidden" id="FJ7_9id" value="${csdVo.f9009 }"/>
						；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9010" size="50" value="${csdVo.f9010 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（2）墙面：
						<select id="FJ7_11" name="f9011" style="width:100px;" ></select>
						<input type="hidden" id="FJ7_11id" value="${csdVo.f9011 }"/>
						；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9012" size="50" value="${csdVo.f9012 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（3）顶棚：
						<select id="FJ7_13" name="f9013" style="width:100px;" ></select>
						<input type="hidden" id="FJ7_13id" value="${csdVo.f9013 }"/>
						；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9014" size="50" value="${csdVo.f9014 }" maxlength="13" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（4）厨具：<input type="text" name="f9015" size="50" value="${csdVo.f9015 }" maxlength="13" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;4.卫生间：
					</td></tr>
					<tr><td>
						...
						<input type="hidden" id="FJ7_16id" value="${csdVo.f9016 }"/>
						；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9017" size="50" value="${csdVo.f9017 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（2）墙面：
						<select id="FJ7_18" name="f9018" style="width:100px;" ></select>
						<input type="hidden" id="FJ7_18id" value="${csdVo.f9018 }"/>
						；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9019" size="50" value="${csdVo.f9019 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（3）顶棚：
						<select id="FJ7_20" name="f9020" style="width:100px;" ></select>
						<input type="hidden" id="FJ7_20id" value="${csdVo.f9020 }"/>
						；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9021" size="50" value="${csdVo.f9021 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（4）卫生器具：<input type="text" name="f9022" size="50" value="${csdVo.f9022 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;5.阳台：
						<select id="FJ7_23" name="f9023" style="width:100px;" ></select>
						<input type="hidden" id="FJ7_23id" value="${csdVo.f9023 }"/>
						；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9024" size="50" value="${csdVo.f9024 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;6.电梯：
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（1）品牌：<input type="text" name="f9025" size="50" value="${csdVo.f9025 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;（2）型号：<input type="text" name="f9026" size="50" value="${csdVo.f9026 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;7.管道：
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9027" size="50" value="${csdVo.f9027 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;8.窗户：
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9028" size="50" value="${csdVo.f9028 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件七 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;9.其他：
					</td></tr>
					<tr><td align="center">
						<textarea class="input_text" name="f9029" rows="10" style="width:100%">${csdVo.f9029 }</textarea>
					</td></tr>
				</table>
			</td></tr>
			<tr><td>
				<table width=100%	>
					...
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;保修期限为：<input type="text" name="f9101" size="30" value="${csdVo.f9101 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件八 ">(不得低于设计文件规定的该工程的合理使用年限)
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9102" size="100" value="${csdVo.f9102 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件八 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;2.屋面防水工程、有防水要求的卫生间、房间和外墙面的防渗漏：
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;保修期限为：<input type="text" name="f9103" size="30" value="${csdVo.f9103 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件八 ">(不得低于5年)
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9104" size="100" value="${csdVo.f9104 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件八 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;3.供热、供冷系统和设备：
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;保修期限为：<input type="text" name="f9105" size="30" value="${csdVo.f9105 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件八 ">(不得低于2个采暖期、供冷期)
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9106" size="100" value="${csdVo.f9106 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件八 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;4.电气管线、给排水管道、设备安装：
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;保修期限为：<input type="text" name="f9107" size="30" value="${csdVo.f9107 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件八 ">(不得低于2年)；
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9108" size="100" value="${csdVo.f9108 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件八 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;5.装修工程：
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;保修期限为：<input type="text" name="f9109" size="30" value="${csdVo.f9109 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件八 ">(不得低于2年)
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="f9110" size="100" value="${csdVo.f9110 }" maxlength="100" class="input2" features="bmust=0,datatype=0,minlength=0,maxlength=50,showtitle=附件八 ">。
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;6.其他：
					</td></tr>
					<tr><td align="center">
						<textarea class="input_text" name="f9111" rows="10" style="width:100%" features="bmust=0,datatype=0,minlength=0,maxlength=2000,showtitle=附件八  6.其他">${csdVo.f9111 }</textarea>
					</td></tr>
					<tr><td>
						&nbsp;&nbsp;&nbsp;&nbsp;(二）其他约定
					</td></tr>
					<tr><td align="center">
						<textarea class="input_text" name="f9112" rows="10" style="width:100%" features="bmust=0,datatype=0,minlength=0,maxlength=2000,showtitle=附件八  (二）其他约定">${csdVo.f9112 }</textarea>
					</td></tr>
				</table>
			</td></tr>
			<tr><td>
