...
<html xmlns="http://www.w3.org/1999/xhtml">
		...
		function doQuery(){
			...
			//frmInfo1.submit();
	 		$.ajax({
				...
				url : "<%=basePath%>/outer/signcontract/doQueryCheck.action",
	...
	<body id="body-layout" class="easyui-layout" style="margin-right: 1px; margin-left: 1px">
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'center',title:'签约查询',iconCls:'icon-ok'" style="background-color: #d9e4f2;">
				<div class="easyui-layout" data-options="fit:true">
					<div data-options="region:'north',split:true,border:false" style="height: 90px; padding-top: 5px;" id="div1">
						<form name="frmInfo1" id="form1" target="listfrm" method="post" action="<%=basePath%>/outer/signcontract/querySignContractList.action">
