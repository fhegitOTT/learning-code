...
<body id="body-layout" class="easyui-layout"  style="margin-right:1px;margin-left:1px">
		<div class="easyui-layout" data-options="fit:true">
			<div data-options="region:'center',title:'合同撤销审批',iconCls:'icon-ok'" style="background-color:#d9e4f2;">
				<div class="easyui-layout" data-options="fit:true">
					<div data-options="region:'north',split:true,border:false" style="height:65px;padding-top:5px;" id="div1"> 
						<form name="frmInfo1" id="form1" target="listfrm" action="<%=basePath%>/inner/contractmanage/cancelSecondAuditList.action" method="post">
							<table width="100%">
							<tr>
								<td>
									...
									&nbsp;&nbsp;状态：<select name="status" id="status" class="easyui-combobox">
												...
												<option value="4" selected="selected">审批</option>
					...
					<div data-options="region:'center',border:false">
						<iframe frameborder="0" height="97%" width="100%" id="listfrm" name="listfrm" src="<%=basePath%>/inner/contractmanage/cancelSecondAuditList.action?status=4"></iframe>
					</div>
				</div>
			</div>
		</div>
