			...
			<form name="frmInfo1" id="form3" target="listfrm" action="<%=basePath%>/inner/contractmanage/cancelQueryResult.action" method="post">
				...
				<table width="100%">
					<c:if test="${list3!=null}">
						<c:forEach items="${list3}" var="a">
							<tr style="height: 30px;">
								<td align="center">
									&nbsp;&nbsp;用户名： ${a.buyerName }&nbsp;&nbsp;密码：
									<input class="easyui-textbox" type="password" name="pwd1" id="pwd1" />
								</td>
							</tr>
						</c:forEach>
					</c:if>
					<tr style="height: 30px;">
						<td align="center">
							&nbsp;&nbsp;&nbsp;&nbsp;
							<a href="javascript:doQuery2()" class="easyui-linkbutton" data-options="iconCls:'icon-save'" style="width: 80px">提 交</a>
							&nbsp;&nbsp;&nbsp;&nbsp;
