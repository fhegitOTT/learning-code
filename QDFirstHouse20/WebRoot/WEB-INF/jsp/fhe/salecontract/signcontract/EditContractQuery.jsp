             ...
             <div class="layui-col-md16" align="center">
                 <form class="layui-form layui-form-pane" action="apllyForm" id="" name="apllyForm" align="center">
		             ...
		             <div class="layui-col-md12" style="text-align: right">
		             		<% if(request.getAttribute("cmd")=="edit"){  %>
		                	 <button class="layui-btn layui-btn-sm layui-bg-orange" id="editBtn"><i class="layui-icon">&#xe642;</i>确认签约</button>
		                 <%} %>
    ...
    <script>
        layui.use(['table', 'laydate', 'form'], function () {
            ...
            table.render({
                ...
                , url: '<%=path%>/outer/signcontractFHE/queryEditContractListFHE.action' //数据接口
                , page: true //开启分页
                , cols: [
                    [ //表头
            ...
            $('#editBtn').on('click', function () {
                ...
                var index=layer.open({
                    ...
                    shadeClose: true,
                    content: '<%=path%>/outer/signcontractFHE/gotoSignContractFHE.action?contractID='+contractID+'&showFlag=1',
	                end: function () {
	                    layer.close();
	                }
                });
