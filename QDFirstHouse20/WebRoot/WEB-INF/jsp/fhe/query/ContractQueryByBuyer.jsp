...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body id="body-layout" class="easyui-layout" style="margin-right: 1px; margin-left: 1px; height:650px;">
			...
			<div data-options="region:'center',title:'合同查询(乙方)',iconCls:'icon-ok'" style="background-color: #d9e4f2;">
				<div class="easyui-layout" data-options="fit:true">
					<div data-options="region:'north',split:true,border:false" style="height: 30%; padding-top: 5px; background-color: #d9e4f2;" id="div1">
						<form name="frmInfo" id="frmInfo" target="listfrm" style="height: 100%" method="post" action="<%=path%>/inner/contractqueryFHE/gotoBuyerQueryList.action">
					...
					multiple:false,editable:false,formatter: formatNullForCombobox" />
								...
								<tr>
									<td>
										<a href="javascript:doClean()" class="easyui-linkbutton" data-options="iconCls:'icon-remove'" style="width: 80px">新签合同</a>
										<a href="javascript:doQuery()" class="easyui-linkbutton" data-options="iconCls:'icon-remove'" style="width: 80px">删除合同</a>
									</td>
								</tr>
							</table>
						</form>
					...
					<div data-options="region:'center',border:false">
						<iframe frameborder="0" height="65%" width="100%" id="listfrm" name="listfrm"></iframe>
					</div>
				</div>
			</div>
		</div>
