			...
			<div data-options="region:'center',title:'合同查询(乙方)',iconCls:'icon-ok'" style="background-color: #d9e4f2;">
				<div class="easyui-layout" data-options="fit:true">
					<div data-options="region:'north',split:true,border:false" style="height: 30%; padding-top: 5px; background-color: #d9e4f2;" id="div1">
						<form name="frmInfo" id="frmInfo" target="listfrm" style="height: 100%" method="post" action="<%=path%>/inner/contractqueryFHE/gotoHouseQueryList.action">
							<table width="100%" align="center">
								...
								<tr>
									...
									<td>
										<input class="easyui-textbox" name="housePrice" id="buyerName" />
									</td>
									<td>
										<div align="right">
											甲方名称：
									...
									<td>
										<input class="easyui-textbox" name="sellerName" id="buyerCardcode"/>
									</td>
									...
									<td>
										<input class="easyui-datebox" name="sellerTele" id="buyerBirth" />
									</td>
								</tr>
									<td>
										<div align="right">
									...
									<td>
										<input class="easyui-textbox" name="sellerAddress" id="buyerCardcode"/>
									</td>
								<tr>
									<td colspan="5"></td>
									<td>
