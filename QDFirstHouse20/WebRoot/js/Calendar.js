...
function Calendar(beginYear, endYear, language, patternDelimiter, date2StringPattern, string2DatePattern) {
	...
	this.colors = {"bg_cur_day":"#D0EBF9","bg_over":"#EFEFEF","bg_out":"#D0EBF9"}
};
...
// get yearOptions 
Calendar.prototype.yearOptions = function(id) {
	var obj=document.getElementById(id);
    yearOptions=function(){
	for (var i=this.beginYear;i<=this.endYear;i++){
     		obj.options.add(new Option(i,i));
     		if(obj.options[i-this.beginYear].value==new Date().getFullYear()){
				obj.options[i-this.beginYear].selected='selected';
     		 }
		}
	}
}

document.writeln('<div id="__calendarPanel" style="position:absolute;visibility:hidden;z-index:9999;background-color:#6699CC;border:1px solid #666666;width:200px;height:216px;">');
...
__ci.document.writeln('td.sat {color:#6699CC;background-color:#EFEFEF;}');
__ci.document.writeln('td.sun {color:#6699CC;background-color:#EFEFEF;}');
