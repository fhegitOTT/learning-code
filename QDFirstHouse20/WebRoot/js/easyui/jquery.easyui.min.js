...
$(this).tooltip("tip").css({color:"#000",borderColor:"#CC9933",backgroundColor:"#FFFFCC",display:"none"});
},onHide:function(){
$(this).tooltip("destroy");
...
{text:"清除",handler:function(o){$(o).combo("setValue","").combo("setText","");$(this).closest("div.combo-panel").panel("close");}}
,
{text:function(_a4e){
