...
public class PaperlessConfig {
    ...
    /* 部署可信手写签章服务的IP  */
    public static String host = "190.111.172.62";
    
    /* 部署可信手写签章服务的port  */
    public static String port = "8080";

    /* 机构编码，需要预先在管理系统中添加此机构的信息，登录管理系统->选择系统管理->选择组织 机构管理->添加机构信息，   */
    public static String operatorCode = "11370200MB28579059";
     
    /* 渠道编码，需要在无纸化管理系统中添加此渠道的信息，登录管理系统->选择系统管理->选择渠道管理->添加渠道信息，  */
    public static String channelCode = "qdsbdcdjzx"; //"c001"; 
    
    /**
     * 接口中的密码是否密文传输，true-密文传输，false或者其他-明文传输，不上送默认为 false
     */
    public static String isEncrypt = "true";
    ...
    // 无纸化Svs接口的访问URL
    public static String svsUrl = protocol + host + ":" + port + "/PaperlessServer/PaperlessSVSServlet";
    // 
    ...
    public static String sealCode = "yz2019121289452243";
}
