...
@DBModel(tablename = "PRESELL_MANAGE_END", sequence = "", id = DBModel.AssignedID)
public class PresellManageEndVO extends AbstractBaseVO {

	private String building_Id_End; // 	楼栋编号
	private int state; // 	预售监管状态
	private String seller_Name; // 	房地产商名称
	private String pre_Salespermit; // 	预售许可证1
	private String presell_Code; // 	入网许可证
	private String manage_Acct_Name; // 	预售许可证2
	private String manage_Bank_Name; // 	监管帐号对应的户名
	private String manage_Acct; // 	监管账户的开户行
	private String manage_No; // 	监管帐号
	private String manage_Start_Time; // 	监管协议号
	private String manage_Create_Time; // 	监管开启时间
	private String manage_End_Time; // 	监管结束时间
	private String create_Time; // 	插入时间
	private String update_Time; // 	更新时间

	@DBMeta(column = "Building_Id_End", name = "楼栋编号", type = "String", primarykey = "true", can_update = "false")
	public String getBuilding_Id_End() {
		return building_Id_End;
	}

	public void setBuilding_Id_End(String Building_Id_End) {
		this.building_Id_End = Building_Id_End;
		this.settings.put("building_Id_End", building_Id_End);
	}
	...
	@DBMeta(column = "Pre_Salespermit", name = "预售许可证1", type = "String")
	...
	@DBMeta(column = "Presell_Code", name = "入网许可证", type = "String")
	...
	@DBMeta(column = "Manage_Acct_Name", name = "预售许可证2", type = "String")
	...
	@DBMeta(column = "Manage_Bank_Name", name = "监管帐号对应的户名", type = "String")
	...
	@DBMeta(column = "Manage_Acct", name = "监管账户的开户行", type = "String")
	...
	@DBMeta(column = "Manage_No", name = "监管帐号", type = "String")
	...
	@DBMeta(column = "Manage_Start_Time", name = "监管协议号", type = "String")
	...
	@DBMeta(column = "Manage_Create_Time", name = "监管开启时间", type = "String")
