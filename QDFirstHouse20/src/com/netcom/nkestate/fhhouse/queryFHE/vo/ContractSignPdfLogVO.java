package com.netcom.nkestate.fhhouse.queryFHE.vo;
...
@DBModel(tablename = "CONTRACT_SIGN_PDF_LOG", sequence = "SEQ_CONTRACT_SIGN_PDF_LOG", id = DBModel.SequenceID)
public class ContractSignPdfLogVO extends AbstractBaseVO {
	...
	@DBMeta(column = "logID", name = "日志编号", type = "long", primarykey = "true", can_update = "false")
	...
	@DBMeta(column = "contractID", name = "合同ID", type = "long")
