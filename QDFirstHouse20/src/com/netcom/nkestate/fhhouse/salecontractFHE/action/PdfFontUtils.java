...
public class PdfFontUtils {
	...
	static{
		try{
			/**
			 * 设置字体 windows路径字体 FONT_TYPE=C:/Windows/fonts/simsun.ttc linux路径字体 宋体 (如果没有这个字体文件，就将windows的字体传上去) FONT_TYPE=/usr/share/fonts/win/simsun.ttc
			 */
			//可以用配置文件读取
			//获取配置
	 ...
	 * 文档超级 排版
	 * @param type
	 * 1-标题 2-标题一 3-标题二 4-标题三 5-正文 6-左对齐
	 */
